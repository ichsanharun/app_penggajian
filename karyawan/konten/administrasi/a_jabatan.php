    <table id="tbl" width="100%">
      ...
      <tr text-align="center">
        ...
        <td>
         <a href="index.php?p=a_jabatan_tools&id=<?php echo $id_jabatan; ?>&aksi=edit" class="fa fa-fw fa-edit" title="edit" title="Ubah Data pimpinan"></a>
         <a href="index.php?p=a_jabatan_tools&id=<?php echo $id_jabatan; ?>&aksi=hapus" title="hapus"
